...
| `reanalysis_finished` | A matching reanalysis attempt completed, remained inconsistent, or failed. | `inconsistency_id`, `inconsistency_type`, `reanalysis_attempt_id`, `source`, `outcome`, `duration_ms`, `change_count`, `returned_evidence_count`, `result_message`, `error_message` |
