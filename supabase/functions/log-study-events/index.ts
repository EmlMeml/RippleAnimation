...
const ALLOWED_EVENT_TYPES = new Set([
  ...
  "reanalysis_started",
  "reanalysis_finished",
  // Accepted temporarily so events buffered by an older deployed client can flush.
  "suggestion_accepted",
  "suggestion_rejected",
  "text_edited", // Legacy event from clients deployed before aggregated change logging.
