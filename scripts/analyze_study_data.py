...
def analyze_sessions(
    ...
    for session_id, session_events in sorted(grouped.items()):
        ...
        output.append({
            ...
            "location_marker_size_changes": counts["location_marker_size_changed"],
            ...
            "passage_changes_submitted": counts["passage_change_submitted"],
            "reanalyses_started": counts["reanalysis_started"],
            "reanalyses_finished": counts["reanalysis_finished"],
...
def analyze_participants(session_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    sum_fields = [
        ...
        "passages_confirmed", "passage_changes_submitted", "reanalyses_started",
        "reanalyses_finished",
